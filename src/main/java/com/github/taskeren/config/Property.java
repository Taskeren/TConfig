...
public class Property {
	...
	Property(String name, String[] values, Type type, boolean read, String[] validValues, String[] validValuesDisplay,
		...
		for(String s : values)
			defaultValueBuilder.append(", [").append(s).append("]");
		this.defaultValue = defaultValueBuilder.toString().replaceFirst(", ", "");
	...
	public Property setDefaultValues(String[] defaultValues) {
		...
		this.defaultValue = builder.toString().replaceFirst(", ", "");
	...
	/**
	 * Sets the array of the config GUI display versions of the valid values that
	 * this String Property can be set to. When an array of valid values is defined
	 * for a Property the GUI control for that property will be a value cycle
	 * button.
	 *
	 * @param validValuesDisplay a String array of the aliases of valid values
	 */
	...
	/**
	 * Gets the array of the config GUI display versions of the valid values that
	 * this String Property can be set to, or null or empty if not defined.
	 *
	 ...
	 *
	 * @param _default The default to provide if the current value is not a valid
	 *                 integer
	 * @return The value
	 */
	...
	/**
	 * Returns the value in this property as a long, if the value is not a valid
	 * long, it will return the initially provided default.
	 *
	 * @return The value
	 */
	public long getLong() {
	...
	/**
	 * Returns the value in this property as a long, if the value is not a valid
	 * long, it will return the provided default.
	 *
	...
	/**
	 * Checks if the current value stored in this property can be converted to a
	 * long.
	 *
	...
	public int[] getIntList() {
		...
		for(String value : values) {
			try {
				...
				Configuration.LOG.warn("Cannot parse " + value + " into Integer.", e);
			}
		}
	...
	public boolean[] getBooleanList() {
		...
		for(String value : values) {
			try {
				...
				Configuration.LOG.warn("Cannot parse " + value + " into Boolean.", e);
			}
		}
	...
	public double[] getDoubleList() {
		...
		for(String value : values) {
			try {
				...
				Configuration.LOG.warn("Cannot parse " + value + " into Double.", e);
			}
		}
